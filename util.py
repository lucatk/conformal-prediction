...
# def plot_image_samples(indices: list[int], X_test: ndarray, y_test: ndarray, y_pred_set: ndarray, class_names: list[str]):
#     return plot_image_samples(indices, X_test, y_test, {'_': y_pred_set}, class_names)
